...
@Component({
  selector: 'app-hipprimary-postoperative',
  templateUrl: './hipprimary-postoperative.component.html',
  styleUrls: ['./hipprimary-postoperative.component.css']
})
export class HipprimaryPostoperativeComponent implements OnInit {
