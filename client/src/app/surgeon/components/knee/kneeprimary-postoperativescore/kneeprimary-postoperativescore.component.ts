...
@Component({
  selector: 'app-kneeprimary-postoperativescore',
  templateUrl: './kneeprimary-postoperativescore.component.html',
  styleUrls: ['./kneeprimary-postoperativescore.component.css']
})
export class KneeprimaryPostoperativescoreComponent implements OnInit {
