...
@Component({
  selector: 'app-kneeprimary-preoperative',
  templateUrl: './kneeprimary-preoperative.component.html',
  styleUrls: ['./kneeprimary-preoperative.component.css']
})
export class KneeprimaryPreoperativeComponent implements OnInit {
  ...
  preoperativefileChangeEvent(fileInput: any) {
    ...
    formData.append("Type", "kneeprimary_preoperativeimage");
