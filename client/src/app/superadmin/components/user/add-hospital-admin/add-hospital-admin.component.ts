...
export class AddHospitalAdminComponent implements OnInit {
  ...
  editFileChangeEvent(fileInput: any) {
    let age = new Date();
    this.editAdmin.editfilename = "hospitaladmin_" + Number(age) + fileInput.target.files[0]['name'];
